...
namespace Ryujinx
{
    public class SwitchSettings : Window
    {
        ...
        private SwitchSettings(Builder builder, HLE.Switch _device) : base(builder.GetObject("SettingsWin").Handle)
        {
            ...
            if (SwitchConfig.LoggingEnableGuest)        { GuestLogToggle.Click();       }
            if (SwitchConfig.LoggingEnableFsAccessLog)  { FsAccessLogToggle.Click();    }
        ...
        private void SaveToggle_Activated(object obj, EventArgs args)
        {
            ...
            if (GuestLogToggle.Active       == false) { SwitchConfig.LoggingEnableGuest        = false; }
            if (FsAccessLogToggle.Active    == false) { SwitchConfig.LoggingEnableFsAccessLog  = false; }
